...
class TestPerformanceSample:
    def _make_sample(self, ts: datetime, hash_rate: int = 0, power: int = 0) -> PerformanceSample:
        return PerformanceSample(timestamp=ts, hash_rate=hash_rate, power=power)
    ...
    def test_graph_returns_series_matching_samples(self):
        ...
        samples = [
            ...
            self._make_sample(now - timedelta(minutes=1), hash_rate=20, power=40),
